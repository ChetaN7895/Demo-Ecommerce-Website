 ...
 const handleSignOut = async () => {
  try {
    ...
    const response = await fetch("https://e-commerce-app-pearl-six.vercel.app/api/users/logout", {
      ...
      credentials: "include", // important if you're using HTTP-only cookies
    });
    ...
    if (response.ok) {
     ...
     // console.error("Logout failed:", errorData); // more specific error
      ...
      <div className="md:flex justify-center hidden">
        <div className="relative w-full max-w-xs ml-2 mr-2">
          <form onSubmit={handleSubmit}>
           <input
  type="text"
  className="block w-full md:w-64 lg:w-80 rounded-md bg-gray-50 dark:bg-gray-700 text-black dark:text-white placeholder-gray-400 focus:outline-none focus:ring focus:ring-blue-400 pl-8 py-1"
  placeholder="Search"
  value={searchTerm}

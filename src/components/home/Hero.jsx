    ...
    <section className="bg-white  dark:bg-gray-900 py-32 lg:py-20">
      <div className="grid px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="max-w-2xl mb-6 font-light text-gray-800 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Elevate Your Wardrobe.
Curated collections that blend modern elegance with timeless sophistication,
Style Made Simple,
Comfortable, versatile fashion you’ll actually want to wear — every day.</p>

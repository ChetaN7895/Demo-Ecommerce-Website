    ...
    <footer className="dark:bg-gray-900  bg-gray-200 text-gray-800 py-20 lg:py-20 px-16 font-sans dark:mt-0 mt-10  bottom-0">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              <a href="https://github.com/ChetaN7895" className="dark:text-gray-400 hover:text-white text-base transition-all">Github</a>
            </li>
            <li>
              <a href="https://www.linkedin.com/in/chetan-solanki-66a6842b5" className="dark:text-gray-400 hover:text-white text-base transition-all">LinkedIn</a>
            </li>
            <li>
              <a href="https://youtube.com/shorts/5oaF9uTAZRQ?si=E_Mx9sRwjdG3D1Rj" className="dark:text-gray-400 hover:text-white text-base transition-all">Youtube</a>
            </li>
          </ul>
        </div>
        <div>
        ...
        <div className="flex items-center lg:justify-center">
          <a href='#'>
            <h1 className='font-extrabold text-3xl dark:text-white'>FashionWaves</h1></a>
        </div>
      </div>
      <hr className="my-8 border-gray-700" />
      <div className="sm:flex sm:items-center sm:justify-between sm:flex-row">
        <p className='dark:text-gray-400 text-sm sm:order-1'>© 2025<a href='https://readymadeui.com/' target='_blank' className="hover:underline mx-1">FashionWave</a>All Rights Reserved.</p>
        <div className="flex space-x-5 max-sm:mt-4">
          <a href="https://www.facebook.com/share/16bGWiTK3N/" className="dark:text-gray-400 hover:text-white text-base transition-all">
          ...
          <a href="https://www.instagram.com/gaming_zone.world?igsh=MWt2NGtuZXlkOGQ1NQ==" className="dark:text-gray-400 hover:text-white text-base transition-all">
            <svg className="w-5 h-5 dark:fill-gray-400 hover:fill-white" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a href="https://www.linkedin.com/in/chetan-solanki-66a6842b5" className="dark:text-gray-400 hover:text-white text-base transition-all">
